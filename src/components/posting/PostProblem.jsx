...
export default function PostProblem() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Prepare problem data and submit via API
      const problemData = {
        title,
        description,
        category,
      ...
      // Call API route to create problem using centralized API wrapper
      ...
      if (!response.ok) {
        ...
        const errorMessage = result.details
          ...
          : result.error || 'Failed to submit problem';
        throw new Error(errorMessage);
      }

      const { problem } = result;
      console.log("Submitted successfully. Problem ID:", problem.id);
      ...
      toast.error("Submission Failed", {
        description: error.message || "An error occurred while submitting your problem. Please try again.",
      });
    } finally {
